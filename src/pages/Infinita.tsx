...
const Infinita: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (activeFilter === 'all') {
        setFilteredProjects(infinitaProjects);
      } else {
        setFilteredProjects(infinitaProjects.filter(project => project.category.includes(activeFilter as any)));
      }
        ...
        <div className="container-custom relative z-10">
          <div className="mb-12 max-w-4xl">
            ...
            <p className="font-body text-lg text-white/80 animate-fade-in" style={{ animationDelay: "100ms" }}>
              Visual storytelling through photography, video, and performance. Exploring intimate narratives 
              and emotional depths through lens-based media.
            </p>
          </div>
